#ifndef KERNEL_INCLUDE_KERNEL_MULTIBOOT2_H_
#define KERNEL_INCLUDE_KERNEL_MULTIBOOT2_H_
...
struct mb2_tag_mem_t {
  mb2_tag_t header;
  uint32_t mem_lower;
  uint32_t mem_upper;
} __attribute__((packed));

struct mb2_tag_cmdline_t {
  mb2_tag_t header;
  unsigned char cmdline[];
} __attribute__((packed));

struct mb2_tag_module_t {
  mb2_tag_t header;
  uintptr_t mod_start;
  uintptr_t mod_end;
  unsigned char name[];
...
struct mb2_tag_rsdp1_t {
  mb2_tag_t header;
  acpi_rsdp1_t rsdp;
} __attribute__((packed));

struct mb2_tag_rsdp2_t {
  mb2_tag_t header;
  acpi_rsdp2_t rsdp;
} __attribute__((packed));
...
#endif  // KERNEL_INCLUDE_KERNEL_MULTIBOOT2_H_
